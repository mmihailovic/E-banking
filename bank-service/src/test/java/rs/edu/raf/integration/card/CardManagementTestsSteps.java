...
//        createCardMsg = cardService.createCard(createCardDto);
    ...
    public void theWorkerBlocksTheCardCreatedByTheUser() {
        List<CardDTO> cardDTOS = getAllCardsByUserId(userId);
        if(cardDTOS == null){
        ...
        CardDTO cardDTO = cardDTOS.get(0);
//        cardNumber = cardDTO.getNumber();
//        cardService.blockCard(cardDTO.getNumber());
    }
    ...
    public void theUserShouldSeeTheCardIsBlocked() {
        ...
        CardDTO cardDTO = cardDTOS.get(0);
//        Assertions.assertEquals(true, cardDTO.getBlocked(), "User see that his card is blocked by worker!");
    }
...
//    }
    ...
    private List<CardDTO> getAllCardsByUserId(Long id){
