...
//import rs.edu.raf.dto.OrderRequest;
//import rs.edu.raf.dto.OrderResponse;
...
//        //KREIRANJE RACUNA
//
//        List<BankAccountDTO> racun = null;
//        try {
...
//
//            racun = objectMapper.readValue(json,  new TypeReference<List<BankAccountDTO>>() {});
//        } catch (Exception e) {
